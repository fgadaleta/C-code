...
#define PCI_VENDOR_ID_FRAGDEV  0x8089
#define PCI_DEVICE_ID_FRAGDEV  0x0001
...
static int pci_ivshmem_init(PCIDevice *dev)
{
    ...
    register_savevm(&s->dev.qdev, "fragdev", 0, 0, ivshmem_save, ivshmem_load,
                                                                        dev);
    ...
    //FG
    s->shmobj = strdup("msi=off,shm='shm',size=16"); 
    fprintf(stderr, "do this by default %s\n", s->shmobj); 
...
static PCIDeviceInfo ivshmem_info = {
    ...
    .vendor_id  = PCI_VENDOR_ID_FRAGDEV,
    .device_id  = PCI_DEVICE_ID_FRAGDEV,
